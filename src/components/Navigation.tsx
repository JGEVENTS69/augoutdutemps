...
const Navigation = () => {
  ...
  return (
    <>
      <header className="bg-[#1A2C44] sticky top-0 z-50 px-4 py-4 shadow-md">
...
/>
          ...
          <div className="hidden md:flex justify-between items-center">
            ...
            <div>
              <button
                onClick={() => setIsOpen(!isOpen)}
                className="p-2 text-white hover:text-white hover:bg-red-500 rounded-full transition-all duration-200"
              >
                {isOpen ? <X className="h-6 w-6" /> : <Menu className="h-6 w-6" />}
              </button>
            </div>
